...
const Home: NextPage = () => {
  return (
    <div className="grid min-h-screen gap-10 bg-slate-400 py-20 px-20 lg:grid-cols-2 xl:grid-cols-3 xl:place-content-center">
      <div className="flex flex-col rounded-3xl bg-white p-6 shadow-2xl">
        ...
        <div className="mt-5 text-center">
          <button
            className="w-3/4 rounded-xl bg-blue-500 p-3 text-center text-white
      ...
      <div className="rounded-3xl bg-white p-6 shadow-2xl lg:col-span-2  xl:col-span-1">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-5">
              <button className="flex aspect-square w-8 justify-center rounded-lg bg-blue-200 text-xl font-medium text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="flex aspect-square w-8 justify-center rounded-lg bg-blue-200 text-xl font-medium text-gray-500">
